...
FG-2 **VERIFIED (Gate B+C 2026-07-11: all 4 features incl. DLSS_G report SUPPORTED on 4070S, no SL errors)**. FG-3 swapchain routing **VERIFIED (Gate B+C 2026-07-11)**. FG-4 (shared token + Reflex sleep + 6 PCL markers) **CODED, awaiting Gate C** (also restores an FG-2 SlBridge revert). NEXT after gate: FG-5 (stable tags + enable FG).
