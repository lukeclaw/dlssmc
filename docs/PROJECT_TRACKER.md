...
FG-2 **VERIFIED (Gate B+C 2026-07-11: all 4 features incl. DLSS_G report SUPPORTED on 4070S, no SL errors)**. FG-3 swapchain routing **CODED, awaiting Gate C**.
