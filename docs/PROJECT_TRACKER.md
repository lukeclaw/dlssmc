...
GATE-D VERIFIED by user: "it all looks good, noise is gone" (walk/strafe/decelerate at
0.5 scale). Remaining M5 polish below.** Iter 1 (y-flip only) did NOT help — correctly so: real bug found
...
- [~] P2-5 Artifact tuning: **translation noise SOLVED 2026-07-11** (mvecScale inversion, user-verified). Still to gauge: mvy sign A/B, entity/particle ghosting (P1-8), pitch-turn check, useAutoExposure.
